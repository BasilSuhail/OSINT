...
def _ingest_health_dict(row: IngestHealthRow) -> dict:
    return {
        ...
        "new_data_n": row.new_data_n,
        "unchanged_n": row.unchanged_n,
        "empty_n": row.empty_n,
        "misconfigured_n": row.misconfigured_n,
        ...
        "last_output": row.last_output.isoformat() if row.last_output else None,
        "last_fetched": row.last_fetched,
        "last_accepted": row.last_accepted,
