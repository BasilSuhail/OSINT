          ...
          <div className="flex flex-col gap-1.5 border-t border-white/5 pt-2">
            ...
            <div className="px-1">
              <Slider
                ...
                //: The thumbs are `input type="range"` underneath, and a form
                //: field with neither a name nor an id cannot be told apart
                //: from any other (#944). Named at the call site rather than
                //: defaulted in the wrapper, because two sliders sharing one
                //: name is the same problem with an extra step.
                name="severity-range"
