...
export function EphemerisChip({ eph }: EphemerisChipProps) {
  ...
  return (
    <div className="pointer-events-none absolute bottom-[calc(8%+48px)] left-3 z-30 rounded-md border border-neutral-800 bg-neutral-950/80 px-2.5 py-1.5 font-mono text-[10px] leading-tight text-neutral-300 backdrop-blur-sm">
