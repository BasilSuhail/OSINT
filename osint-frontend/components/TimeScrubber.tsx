  ...
  return (
    <div
      className={cn(
        ...
        //: its top edge lands flush on the bottom of the screen. On a phone
        //: that edge is above the home indicator: a handle under it does not
        //: get pressed, it swipes the app away (#944).
        narrow
          ? hidden
            ? "bottom-[env(safe-area-inset-bottom)] h-0"
            : "bottom-[calc(env(safe-area-inset-bottom)+0.75rem)] h-11"
          : hidden
            ? "bottom-0 h-0"
            : "bottom-3 h-11",
