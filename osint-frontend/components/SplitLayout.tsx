...
import { COLUMN_TOP, NARROW_COLUMN_TOP, NARROW_PANEL_WIDTH, PANEL_WIDTH } from "@/lib/layout"
...

        {
          ...
          >
            ...
            {popupOpen && (deckShowing || searchTakesColumn) ? (
              <FloatingPanel
                className={cn("absolute bottom-3", isNarrow ? "z-40" : "z-30")}
                style={{
                  width: columnWidth,
            ...
            <FloatingPanel
              ...
              style={{ width: columnWidth, top: columnTop }}
            >
